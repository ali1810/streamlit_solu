...
def page1():
    ...
    st.markdown("<h1 style='text-align: left; color: blue; position: fixed; top: 0; width: 80%;margin-top: -1; padding-top: -1; width: 100%;'>AqSolPred: Online Solubility Prediction Tool</AqSolPred: Online Solubility Prediction Tool>", unsafe_allow_html=True)

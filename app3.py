...
def page1():
    ...
    #st.markdown("<h1 style='text-align: left;position: fixed;  width: 100%; color: blue; margin-top: -0; padding-top: -0.45;'>AqSolPred: Online Solubility Prediction Tool</h1>", unsafe_allow_html=True)
    st.markdown("<h2 style='text-align: left; color: blue; position: fixed; top: 0; width: 100%;margin-top: -1; padding-top: -1; position:
      width: 100%;'>AqSolPred: Online Solubility Prediction Tool</AqSolPred: Online Solubility Prediction Tool>", unsafe_allow_html=True)

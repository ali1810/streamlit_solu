...
def page1():
    ...
    st.markdown("<h1 style='text-align: left;position: fixed; top: 0; width: 100%; color: blue; margin-top: -0.25; padding-top: -0.25;'>AqSolPred: Online Solubility Prediction Tool</h1>", unsafe_allow_html=True)

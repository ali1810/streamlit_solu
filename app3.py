...
def page1():
    ...
    st.markdown("<h1 style='text-align: left;font-size: 10px; position: fixed; top: 0; width: 100%; color: blue; margin-top: -1; padding-top: -1;'>AqSolPred: Online Solubility Prediction Tool</h1>", unsafe_allow_html=True)

...
def page1():
    ...
    st.markdown("<h2 style='text-align: left; color: blue; position: fixed; top: 0; width: 100%;margin-top: -1; padding-top: -1; position: absolute; top: 0; width: 100%;'>AqSolPred: Online Solubility Prediction Tool</h1>", unsafe_allow_html=True)

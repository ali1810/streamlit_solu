...
def page1():
    ...
    st.markdown("<h1 style='text-align: left;position: fixed;  width: 100%; color: blue; margin-top: -0.45; padding-top: -0.45;'>AqSolPred: Online Solubility Prediction Tool</h1>", unsafe_allow_html=True)

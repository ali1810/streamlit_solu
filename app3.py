...
def page1():
    ...
    st.markdown("<h1 style='font-size: 42px ;position: fixed;  top: 1; width: 100%; color: blue; margin-top: 0.5; padding-top: 0.5;'>AqSolPred: Online Solubility Prediction Tool</h1>", unsafe_allow_html=True)
